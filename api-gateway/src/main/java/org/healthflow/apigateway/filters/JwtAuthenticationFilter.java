package org.healthflow.apigateway.filters;

import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.jayway.jsonpath.JsonPath;
import org.healthflow.apigateway.constants.FilterOrder;
import org.healthflow.apigateway.exception.ErrorCodes;
import org.healthflow.apigateway.exception.JWTVerificationException;
import org.healthflow.apigateway.handlers.ExceptionHandler;
import org.healthflow.apigateway.models.Acl;
import org.healthflow.apigateway.models.BaseRequest;
import org.healthflow.apigateway.security.JwtConfigs;
import org.healthflow.apigateway.service.AuthorizationService;
import org.healthflow.apigateway.utils.Utils;
...
import static org.healthflow.common.utils.Constants.AUTH_REQUIRED;
import static org.healthflow.common.utils.Constants.X_JWT_SUB_HEADER;
 ...
 * 2. If auth required, JWT validation is provided by {@link org.healthflow.apigateway.security.JWTVerifierFactory}
