package org.healthflow.apigateway;
...
import org.healthflow.apigateway.config.GenericConfiguration;
...
public class BaseSpec {
    ...
    protected Map<String,Object> getProviderDetails() throws Exception {
        return JSONUtils.deserialize("{ \"participant_code\":\"f7c0e759-bec3-431b-8c4f-6b294d103a74\",\"participant_name\": \"New Teja Hospital888\", \"primary_mobile\": \"+201234567890\", \"primary_email\": \"test@healthflow-hcx-test.gov.eg\", \"roles\": [ \"provider\" ], \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"village\": \"Heliopolis\", \"district\": \"Cairo\", \"state\": \"Cairo\", \"pincode\": \"11341\", \"osid\": \"f901ba37-e09f-4d84-a75f-5e203f8ad4da\", \"@type\": \"address\", \"locality\": \"Heliopolis\" }, \"phone\": [ \"+20-2-3876-5899\" ], \"status\": \"Active\", \"endpoint_url\": \"https://677e6fd9-57cc-466c-80f6-ae0462762872.mock.pstmn.io\", \"payment_details\": { \"iban\": \"EG800010001234567891011121314\", \"bic\": \"NBEGEGCX\", \"osid\": \"da192c1e-5ad4-47bc-b425-de4f7bbc9bd0\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"f7c0e759-bec3-431b-8c4f-6b294d103a74\" ], \"osid\": \"68c5deca-8299-4feb-b441-923bb649a9a3\", \"@type\": \"Organisation\", \"payment\": { \"bic\": \"NBEGEGCX\", \"iban\": \"EG800010001234567891011121314\", \"@type\": \"payment_details\", \"osid\": \"3a3bd68a-848a-4d52-9ec2-07a92d765fb4\" } }", Map.class);
    }

    protected Map<String,Object> getBlockedProviderDetails() throws Exception {
        return JSONUtils.deserialize("{ \"participant_name\": \"New Teja Hospital888\", \"primary_mobile\": \"+201234567890\", \"primary_email\": \"test@healthflow-hcx-test.gov.eg\", \"roles\": [ \"provider\" ], \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"village\": \"Heliopolis\", \"district\": \"Cairo\", \"state\": \"Cairo\", \"pincode\": \"11341\", \"osid\": \"f901ba37-e09f-4d84-a75f-5e203f8ad4da\", \"@type\": \"address\", \"locality\": \"Heliopolis\" }, \"phone\": [ \"+20-2-3876-5899\" ], \"status\": \"Blocked\", \"endpoint_url\": \"https://677e6fd9-57cc-466c-80f6-ae0462762872.mock.pstmn.io\", \"payment_details\": { \"iban\": \"EG800010001234567891011121314\", \"bic\": \"NBEGEGCX\", \"osid\": \"da192c1e-5ad4-47bc-b425-de4f7bbc9bd0\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"f7c0e759-bec3-431b-8c4f-6b294d103a74\" ], \"osid\": \"68c5deca-8299-4feb-b441-923bb649a9a3\", \"@type\": \"Organisation\", \"payment\": { \"bic\": \"NBEGEGCX\", \"iban\": \"EG800010001234567891011121314\", \"@type\": \"payment_details\", \"osid\": \"3a3bd68a-848a-4d52-9ec2-07a92d765fb4\" } }", Map.class);
    }

    protected Map<String,Object> getPayorDetails() throws Exception {
        return JSONUtils.deserialize("{ \"participant_code\": \"new-payor-3\", \"participant_name\": \"New payor 3\", \"primary_mobile\": \"+201234567893\", \"primary_email\": \"payor03@healthflow-hcx-test.gov.eg\", \"roles\": [ \"payor\" ], \"scheme_code\": \"Default\", \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"village\": \"Heliopolis\", \"district\": \"Cairo\", \"state\": \"Cairo\", \"pincode\": \"11341\", \"osid\": \"929d9a60-1fe3-49a5-bae7-4b49970cebbb\" }, \"phone\": [ \"+20-2-3876-5899\" ], \"status\": \"Active\", \"endpoint_url\": \"http://mock-provider.healthflow-hcx-test.gov.eg:8080\", \"payment_details\": { \"iban\": \"EG800010001234567891011121314\", \"bic\": \"NBEGEGCX\", \"osid\": \"68a27687-b8c8-4271-97a1-0af3f53c3f3c\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"20bd4228-a87f-4175-a30a-20fb28983afb\" ], \"osid\": \"ce23ccdc-e645-4e35-97b8-0bd8fef43ecd\" }", Map.class);
    }

    protected Map<String,Object> getPayor2Details() throws Exception {
        return JSONUtils.deserialize("{ \"participant_name\": \"New payor 2\", \"primary_mobile\": \"+201234567892\", \"primary_email\": \"payor02@healthflow-hcx-test.gov.eg\", \"roles\": [ \"payor\" ], \"scheme_code\": \"Default\", \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"village\": \"Heliopolis\", \"district\": \"Cairo\", \"state\": \"Cairo\", \"pincode\": \"11341\", \"osid\": \"513aa2ef-c4d4-4202-9926-816a6d22ab8f\" }, \"phone\": [ \"+20-2-3876-5899\" ], \"status\": \"Active\", \"endpoint_url\": \"http://mock-provider.healthflow-hcx-test.gov.eg:8080\", \"payment_details\": { \"iban\": \"EG800010001234567891011121314\", \"bic\": \"NBEGEGCX\", \"osid\": \"2b9fd445-053e-4f44-8ceb-bb51e3f48a86\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"a97ae3c3-bf32-438f-a63e-5b896393163f\" ], \"osid\": \"8584ba69-6c50-4535-8ad5-c02b8c3180a6\" }", Map.class);
    }

    protected Map<String,Object> getBlockedPayorDetails() throws Exception {
        return JSONUtils.deserialize("{ \"participant_name\": \"New payor 3\", \"primary_mobile\": \"+201234567893\", \"primary_email\": \"payor03@healthflow-hcx-test.gov.eg\", \"roles\": [ \"payor\" ], \"scheme_code\": \"Default\", \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"village\": \"Heliopolis\", \"district\": \"Cairo\", \"state\": \"Cairo\", \"pincode\": \"11341\", \"osid\": \"929d9a60-1fe3-49a5-bae7-4b49970cebbb\" }, \"phone\": [ \"+20-2-3876-5899\" ], \"status\": \"Blocked\", \"endpoint_url\": \"http://mock-provider.healthflow-hcx-test.gov.eg:8080\", \"payment_details\": { \"iban\": \"EG800010001234567891011121314\", \"bic\": \"NBEGEGCX\", \"osid\": \"68a27687-b8c8-4271-97a1-0af3f53c3f3c\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"20bd4228-a87f-4175-a30a-20fb28983afb\" ], \"osid\": \"ce23ccdc-e645-4e35-97b8-0bd8fef43ecd\" }", Map.class);
    }

    protected Map<String,Object> getInactivePayorDetails() throws Exception {
        return JSONUtils.deserialize("{ \"participant_name\": \"New payor 3\", \"primary_mobile\": \"+201234567893\", \"primary_email\": \"payor03@healthflow-hcx-test.gov.eg\", \"roles\": [ \"payor\" ], \"scheme_code\": \"Default\", \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"village\": \"Heliopolis\", \"district\": \"Cairo\", \"state\": \"Cairo\", \"pincode\": \"11341\", \"osid\": \"929d9a60-1fe3-49a5-bae7-4b49970cebbb\" }, \"phone\": [ \"+20-2-3876-5899\" ], \"status\": \"Inactive\", \"endpoint_url\": \"http://mock-provider.healthflow-hcx-test.gov.eg:8080\", \"payment_details\": { \"iban\": \"EG800010001234567891011121314\", \"bic\": \"NBEGEGCX\", \"osid\": \"68a27687-b8c8-4271-97a1-0af3f53c3f3c\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"20bd4228-a87f-4175-a30a-20fb28983afb\" ], \"osid\": \"ce23ccdc-e645-4e35-97b8-0bd8fef43ecd\" }", Map.class);
    }

    protected Map<String,Object> getNotallowedPayorDetails() throws Exception {
        return JSONUtils.deserialize("{ \"participant_name\": \"New payor 3\", \"primary_mobile\": \"+201234567893\", \"primary_email\": \"payor03@healthflow-hcx-test.gov.eg\", \"roles\": [ \"HIE/HIO.HCX\" ], \"scheme_code\": \"Default\", \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"village\": \"Heliopolis\", \"district\": \"Cairo\", \"state\": \"Cairo\", \"pincode\": \"11341\", \"osid\": \"929d9a60-1fe3-49a5-bae7-4b49970cebbb\" }, \"phone\": [ \"+20-2-3876-5899\" ], \"status\": \"Active\", \"endpoint_url\": \"http://mock-provider.healthflow-hcx-test.gov.eg:8080\", \"payment_details\": { \"iban\": \"EG800010001234567891011121314\", \"bic\": \"NBEGEGCX\", \"osid\": \"68a27687-b8c8-4271-97a1-0af3f53c3f3c\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"20bd4228-a87f-4175-a30a-20fb28983afb\" ], \"osid\": \"ce23ccdc-e645-4e35-97b8-0bd8fef43ecd\" }", Map.class);
    }


    protected Map<String,Object> getHCXAdminDetails() throws Exception {
        return JSONUtils.deserialize("{ \"participant_code\": \"1-d2d56996-1b77-4abb-b9e9-0e6e7343c72e\", \"participant_name\": \"HCX Gateway\", \"primary_mobile\": \"\", \"primary_email\": \"hcxgateway@healthflow-hcx-test.gov.eg\", \"roles\": [ \"HIE/HIO.HCX\" ], \"status\": \"Active\", \"endpoint_url\": \"http://mock-gateway.healthflow-hcx-test.gov.eg:8080\", \"encryption_cert\": \"urn:isbn:0-4234\", \"osOwner\": [ \"f7c0e759-bec3-431b-8c4f-6b294d103a74\" ], \"osid\": \"d2d56996-1b77-4abb-b9e9-0e6e7343c72e\", \"signing_cert_path\": \"urn:isbn:0-476-27557-4\"}", Map.class);
    }
